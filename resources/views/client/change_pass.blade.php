    ...
    <div id="app" class="login-box">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <div class="input-group mb-3">
                    <input v-model="customer.re_password" type="password" class="form-control"
                ...
                <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-8">
                        <button v-on:click="change()" type="button" class="btn btn-primary btn-block">Change
                            Password</button>
                    </div>
                    <!-- /.col -->
                </div>
    ...
    <script>
        new Vue({
            ...
            methods: {
                change() {
                    axios
                        .post('/change-password', this.customer)
                        .then((res) => {
                            if (res.data.status) {
