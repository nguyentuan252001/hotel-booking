...
<head>
    ...
    <title>New email template 2022-03-19</title>
    <!--[if (mso 16)]>
<style type="text/css">
                                                        ...
                                                        <table
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Chào mừng,
                                                                        <strong>{{ $data['email'] }}<br></strong>Bạn
                                                                        hoặc ai đó đã yêu cầu reset mật khẩu của tài
                                                                        khoản<strong>.</strong>&nbsp;Để thực hiện việc
                                                                        reset tài khoản vui&nbsp;lòng click vào nút
                                                                        <strong>RESET MẬT KHẨU</strong>&nbsp;ở dưới
                                                                        đây!.</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <span class="es-button-border"
                                                                        style="border-style:solid;border-color:#FFA73B;background:#e06666;border-width:1px;display:inline-block;border-radius:2px;width:auto"><a
                                                                            href="{{ $data['link'] }}"
                                                                            class="es-button es-button-1"
                                                                            target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;border-style:solid;border-color:#e06666;border-width:15px 30px;display:inline-block;background:#e06666;border-radius:2px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center">RESET
                                                                            MẬT KHẨU</a></span></td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                                                        Nếu nút kích hoạt không hoạt động, vui lòng copy
                                                                        liên kết dưới đây và dán vào trình duyệt của
                                                                        bạn.</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#333333;font-size:18px">
                                                                        Nếu như bạn có bất kỳ câu hỏi nào hoặc không
                                                                        thực hiện yêu cầu này có thể bỏ qua hoặc liên hệ
                                                                        với chúng tôi qua địa chỉ email:
                                                                        <em><strong>nguyentuan22552001@gmail.com</strong></em><br>Đây
                                                                        là địa chỉ email tự động, vui lòng không trả lời
                                                                        qua email này!.</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
