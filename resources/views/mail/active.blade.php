                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Chào mừng,
                                                                        <strong>{{ $data['email'] }}</strong>&nbsp;đã
                                                                        đến với website của chúng tôi. Để kích hoạt tài
                                                                        khoản vui lòng click vào nút <strong>KÍCH
                                                                            HOẠT</strong> ở dưới đây!.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Nếu như bạn có bất kỳ câu hỏi nào, có thể liên
                                                                        hệ với chúng tôi qua địa chỉ email:
                                                                        <em><strong>nguyentuan22552001@gmail.com<br></strong></em>Đây
